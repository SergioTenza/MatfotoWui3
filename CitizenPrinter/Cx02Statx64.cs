...
{
    internal class Cx02Statx64 : IDisposable
    {
        public void Dispose()
        {
        }
        ...
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "CvSetFirmwDataWrite")]
        ...
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "CvSetColorDataWrite")]
        static extern int CvSetColorDataWrite_(int lPortNum, int lpData, int dwDataLen);
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "CvSetColorDataVersion")]
        ...
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "CvSetCommand")]
        static extern int CvSetCommand_(int lPortNum, int lpCmd, int dwCmdLen);
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "CvGetCommandEX")]
        ...
        [DllImport("CsjCx2Sts64.dll")]
        public static extern int GetFirmwVersion(int lPortNum, string p);
        [DllImport("CsjCx2Sts64.dll")]
        ...
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "SetFirmwDataWrite")]
        ...
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "SetColorDataWrite")]
        static extern int SetColorDataWrite_(int lPortNum, int lpData, int dwDataLen);
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "SetColorDataVersion")]
        ...
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "SetCommand")]
        static extern int SetCommand_(int lPortNum, int lpCmd, int dwCmdLen);
        [DllImport("CsjCx2Sts64.dll", EntryPoint = "GetCommandEX")]
        ...
        public static int CvGetCommandEX(int lPortNum, string Cmd, int dwCmdLen, ref string rb, int dwRetBuffSize)
        {
            ...
            var gchCmd = GCHandle.Alloc(ByteArray, GCHandleType.Pinned);
            int lpCmd = gchCmd.AddrOfPinnedObject().ToInt32();
            CvGetCommandEXRet = Cx02Statx64.CvGetCommandEX_(lPortNum, lpCmd, dwCmdLen, rb, dwRetBuffSize);
            gchCmd.Free();
        ...
        public static int GetCommandEX(int lPortNum, string Cmd, int dwCmdLen, ref string rb, int dwRetBuffSize)
        {
            ...
            var gchCmd = GCHandle.Alloc(ByteArray, GCHandleType.Pinned);
            int lpCmd = gchCmd.AddrOfPinnedObject().ToInt32();
            GetCommandEXRet = Cx02Statx64.GetCommandEX_(lPortNum, lpCmd, dwCmdLen, rb, dwRetBuffSize);
            gchCmd.Free();
