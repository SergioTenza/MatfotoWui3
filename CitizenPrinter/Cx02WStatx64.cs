...
{
    public static class Cx02WStatx64
    {
        [DllImport("Cx2WStat64.dll")]
        ...
        [DllImport("Cx2WStat64.dll", EntryPoint = "CvSetColorDataVersion")]
        static extern int CvSetColorDataVersion_(int lPortNum, int lpBuff, int bLen);
        [DllImport("Cx2WStat64.dll", EntryPoint = "CvSetColorDataWrite")]
        ...
        [DllImport("Cx2WStat64.dll", EntryPoint = "CvSetFirmwDataWrite")]
        static extern int CvSetFirmwDataWrite_(int lPortNum, int lpBuff, int bLen);
        [DllImport("Cx2WStat64.dll", EntryPoint = "CvSetCommand")]
        static extern int CvSetCommand_(int lPortNum, int lpCmd, int dwCmdLen);
        [DllImport("Cx2WStat64.dll", EntryPoint = "CvGetCommand")]
        ...
        [DllImport("Cx2WStat64.dll", EntryPoint = "CvGetCommandEX")]
        ...
        [DllImport("Cx2WStat64.dll")]
        public static extern int GetFirmwVersion(int lPortNum, string s);
        [DllImport("Cx2WStat64.dll")]
        ...
        [DllImport("Cx2WStat64.dll", EntryPoint = "SetColorDataVersion")]
        static extern int SetColorDataVersion_(int lPortNum, int lpBuff, int bLen);
        [DllImport("Cx2WStat64.dll", EntryPoint = "SetColorDataWrite")]
        ...
        [DllImport("Cx2WStat64.dll", EntryPoint = "SetFirmwDataWrite")]
