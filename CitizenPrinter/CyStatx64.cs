...
{
    internal class CyStatx64 : IDisposable
    {
        public void Dispose()
        {
        }
        ...
        [DllImport("CyStat64.dll", EntryPoint = "CvSetColorDataVersion")]
        static extern int CvSetColorDataVersion_(int lPortNum, long lpBuff, int bLen);
        [DllImport("CyStat64.dll", EntryPoint = "SetColorDataWrite")]
        static extern int CvSetColorDataWrite_(int lPortNum, long lpBuff, int bLen);
        [DllImport("CyStat64.dll")]
        ...
        [DllImport("CyStat64.dll", EntryPoint = "SetFirmwDataWrite")]
        static extern int CvSetFirmwDataWrite_(int lPortNum, long lpBuff, int bLen);
        [DllImport("CyStat64.dll", EntryPoint = "CvSetCommand")]
        static extern int CvSetCommand_(int lPortNum, long lpCmd, int dwCmdLen);
        [DllImport("CyStat64.dll", EntryPoint = "CvGetCommand")]
        static extern int CvGetCommand_(int lPortNum, long lpCmd, int dwCmdLen, string lpRetBuff, int dwRetBuffSize, ref long lpdwRetLen);
        [DllImport("CyStat64.dll", EntryPoint = "CvGetCommandEX")]
        static extern int CvGetCommandEX_(int lPortNum, long lpCmd, int dwCmdLen, string lpRetBuff, int dwRetBuffSize);        
        [DllImport("CyStat64.dll")]
        ...
        [DllImport("CyStat64.dll", EntryPoint = "SetColorDataVersion")]
        static extern int SetColorDataVersion_(int lPortNum, long lpBuff, int bLen);
        [DllImport("CyStat64.dll", EntryPoint = "SetColorDataWrite")]
        static extern int SetColorDataWrite_(int lPortNum, long lpBuff, int bLen);
        [DllImport("CyStat64.dll")]
        ...
        [DllImport("CyStat64.dll", EntryPoint = "SetFirmwDataWrite")]
        static extern int SetFirmwDataWrite_(int lPortNum, long lpBuff, int bLen);
        [DllImport("CyStat64.dll")]
        static extern int SetCutterMode(int lPortNum, int d);
        [DllImport("CyStat64.dll", EntryPoint = "SetCommand")]
        static extern int SetCommand_(int lPortNum, long lpCmd, int dwCmdLen);
        [DllImport("CyStat64.dll", EntryPoint = "GetCommand")]
        static extern int GetCommand_(int lPortNum, long lpCmd, int dwCmdLen, string lpRetBuff, int dwRetBuffSize, ref long lpdwRetLen);
        [DllImport("CyStat64.dll", EntryPoint = "GetCommandEX")]
        static extern int GetCommandEX_(int lPortNum, long lpCmd, int dwCmdLen, string lpRetBuff, int dwRetBuffSize);
        [DllImport("CyStat64.dll")]
        ...
        public static int SetCommand(int lPortNum, string Cmd, int dwCmdLen)
        {
            ...
            long lpCmd = gchCmd.AddrOfPinnedObject().ToInt64();
        ...
        public static int GetCommand(int lPortNum, string Cmd, int dwCmdLen, ref string rb, int dwRetBuffSize, ref int dwRetLen)
        {
            ...
            long lpCmd = gchCmd.AddrOfPinnedObject().ToInt64();
            long lpdwRetLen = gchCmd.AddrOfPinnedObject().ToInt64();
            GetCommandRet = CyStatx64.GetCommand_(lPortNum, lpCmd, dwCmdLen, rb, dwRetBuffSize, ref lpdwRetLen);
            gchCmd.Free();
            gchRetLen.Free();
        ...
        public static int GetCommandEX(int lPortNum, string Cmd, int dwCmdLen, ref string rb, int dwRetBuffSize)
        {
            ...
            var gchCmd = GCHandle.Alloc(ByteArray, GCHandleType.Pinned);
            long lpCmd = gchCmd.AddrOfPinnedObject().ToInt64();
            GetCommandEXRet = CyStatx64.GetCommandEX_(lPortNum, lpCmd, dwCmdLen, rb, dwRetBuffSize);
            gchCmd.Free();
